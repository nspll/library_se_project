...
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 <button type="submit"class="btn btn-danger" onclick="searchingbook()"><span class="glyphicon glyphicon-search" >ค้นหา</button>
   ...
   <form id="editBookForm" style="display: block;">
   <table>
   <td>รหัสISBN<!--input id = "isbn" type="text" name="isbn" value ="" size="10" disabled --> </td>
    <td>      &nbsp;&nbsp;ชื่อหนังสือ<input id = "editbname" type="text" name="bname" value ="" ></td>
     <td>      &nbsp;&nbsp;   ปีที่พิมพ์ <input id = "editbyear" type="text" name="byear" size="4"> </td>
	<td>	   &nbsp;&nbsp;&nbsp;&nbsp;    ผู้แต่ง     <input id = "editbauthor" type="text" name="bauthor" value ="" ></td>
    <td>      &nbsp;&nbsp;    ประเภท 
	  ...
	  <td> &nbsp;&nbsp;   สำนักพิมพ์<input id = "editbpublisher" type="text" name="bpublisher" value ="" ></td>
	  <td> &nbsp;&nbsp;  จำนวน(เล่ม)<input id = "editbtotal" type="text" name="btotal" value =" " > </td>
	   </table>
	   <button class = "button--" onclick = "submiteditbook(isbn)">บันทึกการแก้ไข</button>
   </form>
   <br>
	...
	for(var j=0 ;j<n ; j++)
	{
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) { 
			  ...
			  //alert("fine : "+fine);
			  //alert("fine : "+this.responseText);
			  sumfine = sumfine + parseInt(this.responseText.trim());
			  count++;
			  if(count==n) {
				  alert("ต้องจ่ายค่าปรับทั้งหมด: "+sumfine); //ให้แสดงค่า sumfine เมื่อถึง loop ตัวสุดท้าย
				  location.reload();
			  }
			}
...
/*function fixsearchtype( fixsearchtype)
{
	alert("on click");
  searchtype = fixsearchtype;
  alert(searchtype);
}*/
...
function editbook(isbn)
{
    ...
    var x = document.getElementById("editBookForm");
